      ...
      <div className="bg-white dark:bg-[#152337] rounded-2xl border border-slate-200 dark:border-[#26384D] p-4 shadow-xs">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-3">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            >
              <FileText className="w-4 h-4 text-[#0a3d62] dark:text-[#42A5F5]" />
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-[#0a3d62] hover:bg-[#083150] text-white text-xs font-black shadow-xs transition-all cursor-pointer active:scale-95"
            >
        ...
        {/* Filters Row */}
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mt-3 pt-3 border-t border-slate-100 dark:border-slate-800">
          {/* Period Filter Buttons */}
          <div className="flex items-center gap-1.5 flex-wrap">
            <span className="text-[11px] font-black text-black dark:text-slate-300">الفترة:</span>
            {[
              { key: 'all', label: 'الكل' },
          ...
          <div className="flex items-center gap-2">
            <span className="text-[11px] font-black text-black dark:text-slate-300 shrink-0">رد الفعل:</span>
            <select
              value={selectedReaction}
              onChange={(e) => setSelectedReaction(e.target.value)}
              className="px-2.5 py-1 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 text-xs font-bold text-black dark:text-slate-100 focus:ring-2 focus:ring-[#0a3d62]"
            >
            ...
            return (
              ...
              >
                ...
                <div className="py-2.5 space-y-2">
                  ...
                  {/* Samples Left */}
                  {Array.isArray(visit.samplesGiven) && visit.samplesGiven.length > 0 && (
                    <div className="flex items-center gap-1.5 text-xs text-rose-800 dark:text-rose-300 font-semibold bg-rose-50/70 dark:bg-rose-950/40 p-2 rounded-xl border border-rose-200/60 dark:border-rose-800/50">
