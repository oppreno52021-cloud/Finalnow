...
export const SettingsScreenView: React.FC<SettingsScreenViewProps> = ({
  ...
  return (
    <div id="settings-screen-container" className="space-y-3.5 pb-24 max-w-4xl mx-auto px-1">
      {/* Header Banner - Matches Screenshot */}
      <div className="bg-white dark:bg-[#152337] rounded-2xl border border-slate-200 dark:border-[#26384D] p-5 shadow-xs text-center">
        <h2 className="text-base sm:text-lg font-black text-black dark:text-[#F5F7FA]">
          إعدادات الحساب والنسخ الاحتياطي
        </h2>
        <p className="text-xs font-semibold text-slate-500 dark:text-[#9AA8B8] mt-1">
          تخصيص بيانات المندوب والشركة، وإدارة حفظ واسترجاع بيانات التطبيق
        </p>
      </div>
