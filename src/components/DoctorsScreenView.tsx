...
export const DoctorsScreenView: React.FC<DoctorsScreenViewProps> = ({
  ...
  return (
    <div id="doctors-screen-container" className="space-y-4 pb-24 max-w-4xl mx-auto px-1">
      ...
      <div className="bg-white dark:bg-[#152337] rounded-2xl border border-slate-200 dark:border-[#26384D] p-4 shadow-xs">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-3">
          <div>
            <h2 className="text-base font-black text-black dark:text-[#F5F7FA] tracking-tight">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3 py-2 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-black dark:text-slate-100 text-xs font-bold border border-slate-200 dark:border-slate-700 transition-all cursor-pointer"
              title="رفع ملف إكسيل أو CSV"
            >
              <FileSpreadsheet className="w-4 h-4 text-[#0a3d62] dark:text-[#42A5F5]" />
              <span>📥 رفع إكسيل</span>
            </button>
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3 py-2 rounded-xl bg-[#0a3d62] hover:bg-[#083150] text-white text-xs font-black shadow-xs transition-all cursor-pointer active:scale-95"
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-[#0a3d62] dark:text-[#42A5F5] border border-slate-200 dark:border-slate-700 text-xs font-black shadow-xs transition-all cursor-pointer active:scale-95"
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pr-10 pl-3 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 text-xs font-bold text-black dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-[#0a3d62]"
          />
        </div>

        {/* Filter Controls Row */}
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 mt-3 pt-3 border-t border-slate-100 dark:border-slate-800">
          {/* Area Filter */}
          <div>
            <label className="block text-[11px] font-black text-black dark:text-slate-300 mb-1">المنطقة الجغرافية:</label>
            <select
              value={selectedArea}
              onChange={(e) => setSelectedArea(e.target.value)}
              className="w-full px-2.5 py-1.5 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 text-xs text-black dark:text-slate-100 font-bold focus:outline-none focus:ring-2 focus:ring-[#0a3d62]"
            >
              {areas.map((area) => (
          ...
          {/* Specialty Filter */}
          <div>
            <label className="block text-[11px] font-black text-black dark:text-slate-300 mb-1">التخصص الطبي:</label>
            <select
          ...
          <div className="flex flex-col justify-end">
            <button
              ...
              className={`w-full py-1.5 px-3 rounded-xl text-xs font-bold border transition-all flex items-center justify-center gap-1.5 cursor-pointer ${
                onlyLovesSamples
                  ? 'bg-rose-50 dark:bg-rose-950/40 text-rose-800 dark:text-rose-300 border-rose-300 dark:border-rose-800 shadow-xs'
        ...
        {/* Class Chips Row */}
        <div className="flex items-center gap-1.5 mt-3 pt-2.5 border-t border-slate-100 dark:border-slate-800 flex-wrap">
          <span className="text-[11px] font-black text-black dark:text-slate-300 ml-1">الكلاس:</span>
          ...
          <span className="text-[11px] font-bold text-slate-600 dark:text-slate-400 mr-auto">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                    ...
                    <div className="flex items-start gap-3 min-w-0">
                      ...
                      <div className="space-y-1 min-w-0">
                        <div className="flex items-center gap-2 flex-wrap">
                          <h3 className="text-base font-black text-black dark:text-[#F5F7FA] hover:text-[#0a3d62] dark:hover:text-[#42A5F5]">
                            {doctor.name}
                          </h3>
                ...
                {/* Actions for this doctor */}
                  ...
                  >
                    <button
                      ...
                      className="px-2.5 py-1.5 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-black dark:text-slate-100 text-xs font-bold border border-slate-200 dark:border-slate-700 cursor-pointer"
                    ...
                    <button
                      ...
                      className="p-1.5 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-black dark:text-slate-100 border border-slate-200 dark:border-slate-700 cursor-pointer"
