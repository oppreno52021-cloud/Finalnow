...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#0F1724] text-[#0F172A] dark:text-[#F5F7FA] font-['Cairo',sans-serif] flex flex-col antialiased selection:bg-[#0A3D62] selection:text-white">
